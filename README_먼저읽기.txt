...
2. 랑그릿사_DE_한글패치_v1.1.2.exe를 실행합니다.
...
- v1.1.2의 공식 화면·전투 검증 환경은 RetroArch 1.22.2 / Beetle Saturn 코어입니다.
- 랑그릿사 I의 바리스타 용병이 표시 수치에 맞게 정상적으로 작동하는 것을 확인했습니다.
- 랑그릿사 I의 새 UI 5개 교정은 최종 화면 검수가 남아 있습니다.
